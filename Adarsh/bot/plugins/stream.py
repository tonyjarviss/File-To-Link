...
async def private_receive_handler(c: Client, m: Message):
    ...
    try:
        ...
        stream_link2 = f"https://filmy4wax.blogspot.com/2023/08/watch-filename-your-channel-name-body.html?m={Var.URL}{str(log_msg.id)}/{quote_plus(get_name(log_msg))}?hash={get_hash(log_msg)}"
