...
@StreamBot.on_message((filters.regex("login") | filters.command("signin")) , group=4)
...
async def private_receive_handler(c: Client, m: Message):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            if user.status == "kicked":
                await c.send_message(
                    chat_id=m.chat.id,
                    text="You are banned!\n\n  **Cᴏɴᴛᴀᴄᴛ Dᴇᴠᴇʟᴏᴘᴇʀ [Jishu Developer](https://t.me/CallAdminRobot) Hᴇ Wɪʟʟ Hᴇʟᴘ Yᴏᴜ**",
            ...
            await c.send_message(
                chat_id=m.chat.id,
                text="**Something Went Wrong. Contact My Boss** [Jishu Developer](https://t.me/CallAdminRobot)",
    ...
    try:
        ...
        msg_text ="""<b><u>Your Link Generated!</u></b>\n\n<b>📂 File Name :</b> `{}`\n\n<b>📦 File Size :</b> {}</b>\n\n<b><u>Tap To Copy Link 👇</u></b>\n\n<b>📥 Download :</b> `{}`\n\n<b> 🖥 Stream  :</b> `{}`\n\n<b>🚸 Note :</b> Link Won't Expire Till I Delete"""
